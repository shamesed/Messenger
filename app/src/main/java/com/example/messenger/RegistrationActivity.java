    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String age1 = getTrimmedValue(editTextAge);
                if (email.isEmpty() || password.isEmpty() || name.isEmpty() || lastName.isEmpty() || age1.isEmpty()) {
                    Toast.makeText(RegistrationActivity.this, R.string.please_enter_all_fields, Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        viewModel.getUser().observe(this, new Observer<FirebaseUser>() {
            ...
            public void onChanged(FirebaseUser firebaseUser) {
                if (firebaseUser != null) {
                    ...
                    finish();
                    Toast.makeText(RegistrationActivity.this, "Successful Authorization!" , Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
